...
function(e, t) {
	...
	function(e, t, n) {
		...
		i = function() {
			...
			e.CDN = "https://cdn.jsdelivr.net/npm/vditor@3.4.7",
			e.MARKDOWN_OPTIONS = {
				autoSpace: !1,
				chinesePunct: !1,
				codeBlockPreview: !0,
	...
	function(e, t, n) {
		...
		s = function(e) {
			...
			window.vditorImageIntersectionObserver ? (window.vditorImageIntersectionObserver.disconnect(), e.querySelectorAll("img").forEach((function(e) {
				...
				e.forEach((function(e) { (void 0 === e.isIntersecting ? 0 !== e.intersectionRatio: e.isIntersecting) && e.target.getAttribute("data-src") && t(e.target)
				}))
		...
		w = function(e, t) {
			if (void 0 === t && (t = "zh_CN"), "undefined" != typeof speechSynthesis && "undefined" != typeof SpeechSynthesisUtterance) {
				...
				if (!i) { (i = document.createElement("div")).className = "vditor-speech",
	...
	function(e, t) {
		...
		n.prototype.diff_linesToChars_ = function(e, t) {
			...
			function i(e) {
				...
				i = 0,
				a = -1,
				l = n.length; a < e.length - 1;) { - 1 == (a = e.indexOf("\n", i)) && (a = e.length - 1);
	...
	function(e, t, n) {
						...
						if (t.classList.contains("vditor-menu--current")) if ("strike" === l && (l = "strikeThrough"), "quote" === l) {
							...
							t.classList.add("vditor-menu--disabled");
								...
								if ("" === o.toString()) {
									...
									h.focus(),
									i = !1
								} else { (f = document.createElement("a")).setAttribute("href", ""),
		...
		we = function(e, t) { (e.options.upload.url || e.options.upload.handler) && t.addEventListener("drop", (function(t) {
				...
				this.element.children[0].addEventListener(Object(u.b)(), (function(r) {
					if (r.preventDefault(), !n.element.firstElementChild.classList.contains(a.a.CLASS_MENU_DISABLED)) {
						...
						n.element.children[0].classList.add("vditor-menu--current");
							...
							audio: !0
						}).then((function(r) { (t = new gn(r)).recorder.onaudioprocess = function(e) {
								if (t.isRecording) {
